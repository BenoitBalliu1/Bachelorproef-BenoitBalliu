...
\begin{itemize}
 ...
 \item Er kunnen zich geen verboden documenten op de virtuele machines bevinden. Enkel de documenten die de docent op de machines heeft geplaatst (eventueel via GitHub Classroom).
\end{itemize}
